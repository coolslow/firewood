...
class CityWidePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _CityWidePageState();
  }
}

class _CityWidePageState extends State<CityWidePage> with AutomaticKeepAliveClientMixin {
