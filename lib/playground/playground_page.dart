  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        FItem.getItem(context, "文字阴影", TextShadowDemo()),//ok
        FItem.getItem(context, "圆角图片", CircleAvatarDemoPage()),//ok
        FItem.getItem(context, "图文混排", IconFontDemo()),//ok
        FItem.getItem(context, "字体", FontDemo()),//ok
        FItem.getItem(context, "3D", TransformDemo()),
        FItem.getItem(context, "平台提示", ToastDemoPage()),
        FItem.getItem(context, "Sliver滑动", SliverDemoPage()),//ok
        ...
        FItem.getItem(context, "列表", ListDemoPage()),//ok
        FItem.getItem(context, "页级列表", PageViewDemoPage()),//ok
        ...
        FItem.getItem(context, "分割线", DashDividerDemo()),// 不需要了
        FItem.getItem(context, "MediaQuery", MediaQueryDataScreen()),//ok
